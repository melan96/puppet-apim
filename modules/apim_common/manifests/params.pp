...
class apim_common::params {
  ...
  $remote_jdk = "https://corretto.aws/downloads/resources/8.242.08.1/amazon-corretto-8.242.08.1-linux-x64.tar.gz"
  ...
  case $profile {
    ...
    'apim_gateway': {
      $pack = "https://github.com/wso2/product-apim/releases/download/v3.2.0/wso2am-3.2.0.zip"
  ...
  $wso2am_db_username = 'apiadmin'
  $wso2am_db_password = 'apiadmin'
